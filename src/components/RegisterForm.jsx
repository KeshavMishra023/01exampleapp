...
export const RegisterForm = () => {
    ...
    return<>
    <p className="text-center py-7">Hello, My Name is <span className="text-blue-600">{firstName}</span> and <span className="text-blue-600"> {lastName}</span> or email id is <span className="text-blue-600">{email}</span> and this is my password <span className="text-blue-600">{password}</span> and my phone number is <span className="text-blue-600">{phone}</span>. </p>
